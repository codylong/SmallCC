...
class Annealer(object):
    ...
    def default_update(self, step, T, E, acceptance, improvement):
        ...
        if step == 0:
            print(' Temperature        Energy    Accept   Improve     Elapsed   Remaining    CC',
                  file=sys.stderr)
            ...
            print('\r%12.5f  %12.2f  %7.2f%%  %7.2f%%  %s  %s   %s\r' %
                  (T, E, 100.0 * acceptance, 100.0 * improvement,
                   time_string(elapsed), time_string(remain), self.cc), file=sys.stderr)
            sys.stderr.flush()
