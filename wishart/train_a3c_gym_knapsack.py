...
# this causes the program to load the latest (upgraded) libraries from the local install rather than the old default packages in the global install on the oxford hydra cluster
# import sys
...
def main():
    ...
    if args.seed == -1: args.seed = random.randint(0, 2 ** 32 - 1)
    ...
    def make_env(process_idx, test):
        ...
        env.env.set_output_file_path(args.outdir)
    ...
    obs_space = sample_env.env.observation_space
    action_space = sample_env.env.action_space
    ...
    if args.demo:
        ...
        eval_stats = experiments.eval_performance(
            ...
            explorer=ConstantEpsilonGreedy(args.epsilon, lambda: random.randint(0, num_actions - 1)))
        ...
        if args.MCTS:
            ...
            experiments.train_agent_async_MCTS(
                agent=agent,
                outdir=args.outdir,
